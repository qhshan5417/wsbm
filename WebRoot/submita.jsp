...
<html>
  <head>
    ...
    <title>状态变化</title>
    <meta http-equiv="refresh" content="1;URL=useraction.jsp">
   ...
   <%
    request.setCharacterEncoding("utf-8"); 
     try{
         ...
         String sql="insert into submit values('"+Tname+"','"+Taction+"','"+T+"','"+B+"','"+c+"','"+Ttime+"','"+Tsite+"','"+name+"','"+Txh+"',null,null,null,'"+teacher+"')";
